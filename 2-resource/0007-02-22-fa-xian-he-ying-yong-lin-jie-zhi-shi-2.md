...
那我们进入到解释问题的三个层次，就是你怎么样去看待问题。这个很常见，我自己有个问题管理模型叫PKS。很多小伙伴在跟着我学问题管理的时候，在定义这个P（Problem）时很难定义，这个P它具体问题是什么?他说一说具体问题；具体问题背后的原因是什么？然后他对原因分析，到原因分析这个部分已经要呈现出人和人的不一样了。其实在看问题上就能看出来不一样。有的人看问题就看的特别浅层，有的人看问题就看的稀里糊涂的。等到去往底层规律或者说去往本质上，那就不见得完完全全去得了了。这个部分没有太多的建议要提或者要了解的。他后面又做了一个案例，“看得见的设计与看不见的设计”，用万维钢和李笑来老师做了一个对比，来获得了一个案例的比较。这个对比不仅仅从APP表面上对比，更从内在来对比。并且分了不同的对比—内容更新，机会差异还有用户价值挖掘这个部分，

之后呢在156页上面又形成了两个部分的对比，一直到157页。但这个对比的内容，我就不在这里说了，因为它是例子，例子你可以换成任何的一个例子。如果我讲的这里面比如说“看得见的设计和看不见的设计”，可能就关联到其他书里面去了，那可能要讲更多的内容，这不是我们这个书的重点 。那么这个书的重点，你就看，“看不见的设计”到哪就停了呢？到157页的倒数第二段“从这个案例可以看出来我在……的积累里面，到这里面去，认知能力可以迁移就是因为临界知识可以在多个领域中发挥作用呢”。那我们判断下，他其实在讲什么呢？他其实在讲解释问题，他自己是怎么解释问题的，用临界知识如何解释问题。那这不是也在咱们的流程图上画的嘛，你可以标注一下，临界知识到解释问题那个地方一直到157页的倒数第二段结束就行了，这都是解释问题，所以讲到这还都在谈怎么解释问题的事情。
